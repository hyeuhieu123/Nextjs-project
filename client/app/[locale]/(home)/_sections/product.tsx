              ...
              return (
                ...
                >
                  {item.name}
                    ...
                    className="flex flex-col flex-grow-0 flex-shrink-0 p-0 m-0 w-[200px] h-[200px] md:w-[300px] md:h-[300px] lg:w-[300px] lg:h-[350px] hover:border-black cursor-pointer  "
                  >
